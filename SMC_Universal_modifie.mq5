...
string AnalyzeSymbolForTrading(string symbol)
{
   ...
   analysis += "SPREAD: " + IntegerToString((int)spread) + " points | ";
...
void AnalyzePastCorrectionZones(string symbol, ENUM_TIMEFRAMES timeframe = PERIOD_M1)
{
   ...
   // TODO: Implémenter la fonction StoreCorrectionDataInSupabase
   ...
   Print("📝 NOTE: Stockage Supabase désactivé - fonction StoreCorrectionDataInSupabase à implémenter");
...
void ProcessAIDecision_Legacy(string jsonData)
{
   ...
   // Si aucune donnée (WebRequest/parsing), ne pas forcer HOLD 50%.
   ...
   // Si des champs manquent, ne pas inventer HOLD 50%.
}
...
void ProcessAIDecision(string jsonData)
{
   ...
   // On vide les champs pour afficher OFF au dashboard.
   if(StringLen(jsonData) < 5)
   {
      g_aiConnected = false;
      g_lastAIAction = "";
