...
input int    PreSpikeDelaySec           = 120;   // Retard exécution après signal (sec)
input int    PreSpikeLookbackM1Bars     = 10;    // Bougies M1 pour estimer drift pré-spike
input double PreSpikeMinImminencePct    = 62.0;  // Entrer immédiat seulement si imminence >=
input double PreSpikeMinPreSpikePct     = 38.0;  // pre_spike_pct min (TV/serveur)
input double PreSpikeDelayMinImminence  = 48.0;  // Après retard: imminence min pour entrer
